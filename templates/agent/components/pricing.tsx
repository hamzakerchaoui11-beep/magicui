...
const plans = [
  { name: "Free", price: "$0", period: "forever", features: ["100 tasks/month", "5 integrations", "Community support"], cta: "Get started", highlighted: false },
  { name: "Pro", price: "$39", period: "per month", features: ["10,000 tasks/month", "Unlimited integrations", "Priority support", "Custom agent personas", "API access"], cta: "Start trial", highlighted: true },
  { name: "Team", price: "$99", period: "per month", features: ["Unlimited tasks", "Shared agent workspace", "Dedicated support", "SSO", "Audit logs"], cta: "Contact sales", highlighted: false },
];
    ...
    <section id="pricing" className="border-t border-border py-24">
      <div className="mx-auto max-w-6xl px-4">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-16 text-center">
          ...
          <h2 className="text-balance text-4xl font-bold tracking-tight text-foreground md:text-5xl">Pay for what you use</h2>
        </motion.div>
