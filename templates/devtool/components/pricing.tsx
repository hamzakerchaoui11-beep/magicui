...
const plans = [
  { name: "Hobby", price: "$0", period: "forever", features: ["3 projects", "100 builds/month", "7-day build history", "Community support"], cta: "Start free", highlighted: false },
  { name: "Pro", price: "$29", period: "per month", features: ["Unlimited projects", "Unlimited builds", "90-day history", "Priority support", "Team members", "Custom alerts"], cta: "Start trial", highlighted: true },
  { name: "Enterprise", price: "Custom", period: "", features: ["Everything Pro", "SLA guarantee", "SSO & SAML", "Dedicated support", "On-premise option"], cta: "Contact us", highlighted: false },
];
    ...
    <section id="pricing" className="border-t border-border py-24">
      <div className="mx-auto max-w-6xl px-4">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-16 text-center">
          ...
          <h2 className="text-balance text-4xl font-bold tracking-tight text-foreground md:text-5xl">Simple pricing for every team</h2>
        </motion.div>
