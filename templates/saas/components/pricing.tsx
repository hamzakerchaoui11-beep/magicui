...
const plans = [
  { name: "Starter", price: "$0", period: "forever", features: ["5 team members", "10 workflows", "Community support", "Basic analytics"], cta: "Start free", highlighted: false },
  { name: "Growth", price: "$49", period: "per month", features: ["25 team members", "Unlimited workflows", "Priority support", "Advanced analytics", "Custom integrations"], cta: "Start trial", highlighted: true },
  { name: "Enterprise", price: "Custom", period: "", features: ["Unlimited members", "Unlimited workflows", "Dedicated support", "SSO & SAML", "SLA guarantee"], cta: "Contact sales", highlighted: false },
];
    ...
    <section id="pricing" className="border-t border-border py-24">
      <div className="mx-auto max-w-6xl px-4">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-16 text-center">
          ...
          <h2 className="text-balance text-4xl font-bold tracking-tight text-foreground md:text-5xl">Start free, scale as you grow</h2>
        </motion.div>
